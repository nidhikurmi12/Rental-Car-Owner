...
const navItems: NavItem[] = [
  ...
  },
  {
   ...
   { name: "Cancelled Bookings", path: "/cars/cancelled", pro: false },
      { name: "Return Status Update", path: "/cars/return-status", pro: false },
         { name: "Upload Vehicle Condition", path: "/cars/vehical/upload", pro: false },
    ],
  },
