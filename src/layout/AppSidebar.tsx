...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: <TableIcon />,
    subItems: [
      { name: "All Bookings List", path: "/", pro: false },
      { name: "Upcoming Bookings", path: "/", pro: false },
      { name: "Ongoing Bookings", path: "/calendar", pro: false },
      { name: "Completed Bookings", path: "/", pro: false },
   { name: "Cancelled Bookings", path: "/", pro: false },
      { name: "Return Status Update", path: "/", pro: false },
         { name: "Upload Vehicle Condition", path: "/", pro: false },
    ],
  },
